...
describe 'index', ->
  describe '#generate()' , ->
    it 'should copy files verbatim without replaces', ->
      archie.generate 'test/archetypes/no_replace', 'test/sandbox/no_replace'
    ...
    it 'should filter file names', ->
      archie.generate 'test/archetypes/file_names', 'test/sandbox/file_names', var1: 'awesome'
      fs.readFileSync('test/sandbox/file_names/awesome.json', 'utf8').should.equal "nothing\n"

    it 'should filter files', ->
      archie.generate 'test/archetypes/one_var', 'test/sandbox/one_var', asdf: 'cool site'
    ...
    it 'should filter multiple variables', ->
      archie.generate 'test/archetypes/multiple_vars/', 'test/sandbox/multiple_vars/', projectName: 'unknown', version: '9.0.1'
